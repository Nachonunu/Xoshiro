/*! Xoshiro128 CPP11 v0.1 | CC0 1.0 (https://creativecommons.org/publicdomain/zero/1.0/deed) */
#ifndef _XOSHIRO_HPP
#define _XOSHIRO_HPP
...
public:
	...
	Xoshiro() {}
	Xoshiro(result_type seed) { Init_Int(seed); }
	Xoshiro(unsigned long seed[], unsigned long seed_length) { Init_Array(seed, seed_length); }
	Xoshiro(SEED* seed) { Init_Data(seed); }
	~Xoshiro() {}
