/*! Xoshiro256 CPP v0.1 | CC0 1.0 (https://creativecommons.org/publicdomain/zero/1.0/deed) */
...
public:
	...
	Xoshiro256ss(unsigned long long seed[], unsigned long long seed_length) { Init_Array(seed, seed_length); }
	...
	void Init_Array(unsigned long long seed[], unsigned long long seed_length) {
...
public:
	...
	Xoshiro256p(unsigned long long seed[], unsigned long long seed_length) { Init_Array(seed, seed_length); }
